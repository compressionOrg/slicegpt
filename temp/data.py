...
def get_calibration_dataloader(
    ...
    if 'wikitext2' in dataset_name:
        ...
        #     split='train'
        # )
        train_data = load_from_disk("/home/zhangyingying/.cache/datasets/wikitext/train")
        ...
        # )
        train_data = load_from_disk("/home/zhangyingying/.cache/datasets/c4/train")
        random_indices = random.sample(range(len(train_data)), num_samples)
        train_data = train_data.select(random_indices)
        train_dataset = process_pretrain_data(train_data, tokenizer, seq_len, 'text')
        data_collator = None
...
def get_evaluation_dataloader(dataset_name: Literal["wikitext2", "ptb", "c4"], tokenizer):
    ...
    if "ptb" in dataset_name:
        ...
        #     trust_remote_code=True
        # )
        valdata = load_from_disk("/home/zhangyingying/.cache/datasets/ptb/validation")
    ...
    if "c4" in dataset_name:
        ...
        #     trust_remote_code=True
        # )
        testdata = load_from_disk("/home/zhangyingying/.cache/datasets/c4/validation")
        testenc = tokenizer("\n\n".join(testdata["text"]), return_tensors="pt")
        return testenc
    raise NotImplementedError

def get_test_data(name, tokenizer, seq_len=2048, batch_size = 1):
    ...
    if 'wikitext2' in name:
        ...
        test_data = load_from_disk("/home/zhangyingying/.cache/datasets/wikitext/test")
        test_dataset = process_data(test_data, tokenizer, seq_len, 'text')
    if 'ptb' in name:
        # test_data = load_dataset('ptb_text_only', 'penn_treebank', split='test')
        test_data = load_from_disk("/home/zhangyingying/.cache/datasets/ptb/test")
        ...
        #     trust_remote_code=True
        # )
        test_data = load_from_disk("/home/zhangyingying/.cache/datasets/c4/validation")
